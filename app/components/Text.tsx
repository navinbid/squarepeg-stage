...
export function Section({
  ...
  const paddings = {
    x: 'px-5 md:px-8 lg:px-12',
    y: 'py-6 md:py-8 lg:py-12',
    swimlane: 'pt-4 md:pt-8 lg:pt-12 md:pb-4 lg:pb-8',
    all: 'p-5 md:p-8 lg:p-12',
  };
...
export function PageHeader({
  ...
  const variants: Record<string, string> = {
    default: 'grid gap-8 p-6 py-8 md:p-8 lg:p-12 justify-items-start',
    blogPost:
      'grid md:text-center gap-4 p-6 py-8 md:p-8 lg:p-12 md:justify-items-center',
    allCollections:
